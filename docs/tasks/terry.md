...
- [ ] **Build a dedicated Riviera 4300 detail / info page in the New Riviera Yachts section.** Queued pending Clark's content (he is sending it shortly). Lives under the Buy > New Yachts tab alongside the 4300 Sports Express panel; match the site design system. Follow-on: once the detail page is live, add a link in the 4300 feature email (`4300-feature-email-preview.html` / its Constant Contact send) that drops the reader straight into the detail page.
