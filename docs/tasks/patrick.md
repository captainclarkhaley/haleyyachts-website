...
- [ ] **Local citations / NAP consistency** - build consistent Name/Address/Phone citations across major directories: Yelp, Bing Places, Apple Maps, IYBA directory, and marine-industry directories. Use the exact same NAP as the now-live GBP: Haley Yachts, 2401 PGA Blvd, Suite 164, Palm Beach Gardens, FL 33410, 561-817-1547, haleyyachts.com (Jupiter / Palm Beach / Treasure Coast = service area).
